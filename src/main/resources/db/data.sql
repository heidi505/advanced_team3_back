...
insert into user_tb(`email`,`nickname`,`password`, `phone_num`, `birthdate`, `created_at`, `profile_id`)values('cos@nate.com','그노','1111','01022223333','2024-01-16', now(), 2);
insert into user_tb(`email`,`nickname`,`password`, `phone_num`, `birthdate`, `created_at`, `profile_id`)values('love@nate.com','채비니','1111','01050186937','2024-01-16', now(), 3);
...
insert into friend_tb(`user_id1`, `user_id2`,`is_friend`) values ('1','3',true);
insert into friend_tb(`user_id1`, `user_id2`,`is_friend`) values ('1','2',true);
insert into friend_tb(`user_id1`, `user_id2`,`is_friend`) values ('1','4',false);
insert into friend_tb(`user_id1`, `user_id2`,`is_friend`) values ('1','5',false);
